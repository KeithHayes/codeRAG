<?php
// assets/php/run_format_paragraphs.php
// Execute format_paragraphs.py which reads sansextrasegments.txt and writes formattedparagraphs.txt
...
$python_script = __DIR__ . '/../py/format_paragraphs.py';
...
echo json_encode([
    'success' => true,
    'message' => 'format_paragraphs.py completed successfully'
]);
?>