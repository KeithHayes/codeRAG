<?php
// assets/php/save_sanstimestamps.php
// Save timestamp-cleaned transcript to sanstimestamps.txt
...
$file_path = $transcript_dir . '/sanstimestamps.txt';
$result = file_put_contents($file_path, $transcript);

if ($result === false) {
    echo json_encode([
        'success' => false,
        'error' => 'Failed to save timestamp-cleaned transcript file'
    ]);
    exit;
}
